	...
	public UserFrame() throws ParseException {
		...
		btnCautaCurse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!testFailed) {
					cautaCurse();
					pages.show(UserFrame.this.getContentPane(), "FLIGHTS PANEL");
					selection();
		...
		btnInapoiDest.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				pnlOptions.revalidate();
				pnlOptions.repaint();
				pages.show(UserFrame.this.getContentPane(), "DEST PANEL");
			}
		});
		...
		btnRezervare.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				pages.show(UserFrame.this.getContentPane(), "USER DATA");
